...
std::vector<uint8_t> CmdRead15693Tag::serializeParameters() const {
...
void RetRead15693Tag::deserializeParameters(const std::span<const uint8_t> data) {
  tagData.assign(data.begin(), data.end());
}

void RetRead15693Tag::render() {
  static MemoryEditor mem_edit;
